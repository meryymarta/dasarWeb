<div class="container-fluid">
    <div class="row">
        ...
        // 1. Query utama untuk mengambil detail Anggota, Jabatan, dan User
        // PERBAIKAN: Menambahkan escape pada "user" dan mengganti mysqli_*
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <!-- Form ACTION harus mengarah ke fungsi/edit.php -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="jabatan" aria-label="Default select example">
                                        ...
                                        <?php
                                        // 2. Query untuk mengisi Dropdown Jabatan
                                        // PERBAIKAN: Mengganti mysqli_*
